...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        #### dataset_mode: which dataset_loader selected [ShadowParam, WeaklyShadowParam]
        ...
        parser.add_argument('--no_rotate', action='store_true', help='if specified, do not flip the images for data augmentation')
        ...
        parser.add_argument('--lambda_GAN_mask', type=float, default=0.0)
        ...
        parser.add_argument('--illumination', type=float, default=0.0)
        parser.add_argument('--conditionD', type=float, default=0.0)
