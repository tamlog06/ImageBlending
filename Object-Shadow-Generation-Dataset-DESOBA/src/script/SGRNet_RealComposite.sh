...
#dataroot='../../DESOBA_DATASET/CompositeImages/1_ForegroundObject/'
#dataroot='../../DESOBA_DATASET/CompositeImages/test/'
dataroot='../../../images/'
...
bg_shadow_path=${dataroot}'/background_shadow_mask_bin'
